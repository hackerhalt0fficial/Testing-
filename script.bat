...
echo cd /d "!LAZAGNE_DIR!\Windows"
echo if exist "laZagne.exe" (
echo     laZagne.exe all ^> "!CRON_LOG!" 2^>^&1
echo ) else if exist "laZagne.py" (
echo     python laZagne.py all ^> "!CRON_LOG!" 2^>^&1
echo )
) > "%SCRIPT_DIR%"
